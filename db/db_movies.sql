...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 01, 2021 lúc 09:37 AM
...
INSERT INTO `tbl_listcategory` (`film_id`, `category_id`) VALUES
(2, 10),
(3, 4),
(4, 2),
(4, 10),
...
ALTER TABLE `tbl_comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tbl_comments_tbl_users` (`user_id`);
...
ALTER TABLE `tbl_rating`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tbl_rating_tbl_users` (`user_id`);
...
--
ALTER TABLE `tbl_comments`
  ADD CONSTRAINT `fk_tbl_comments_tbl_users` FOREIGN KEY (`user_id`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_rating`
  ADD CONSTRAINT `fk_tbl_rating_tbl_users` FOREIGN KEY (`user_id`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
